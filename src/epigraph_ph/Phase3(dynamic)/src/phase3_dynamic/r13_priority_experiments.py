    ...
    specs: list[dict[str, Any]] = [
        {
            ...
            "title": "Conserved annual incidence/death/PLHIV gate on R18",
            "family": "official_annual_challenge_gate",
            "candidate_family": "r18_evidence_backed_art_process",
            "row_scope": "official_annual_q4",
            "metrics": tuple(OFFICIAL_ANNUAL_CHALLENGE_METRICS),
            "horizons": (1,),
            "r10_required": False,
            "hypothesis": "The R18 branch is publishable only if annual incidence, deaths, PLHIV, and annual cascade anchors score as a conserved mass-balance triplet without training on validation-only annual targets.",
        },
        {
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R18 evidence-backed ART process program route stress test",
            "family": "r18_evidence_backed_art_process",
            "row_scope": "program",
            "metrics": da_metrics,
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If the R17 gain was scientifically real rather than teacher leakage, a train-origin ART initiation/retention/removal/reporting-intensity process on top of R16 should improve 3y/5y program trajectory without breaking the stock cone.",
        },
        {
        ...
        },
        {
            ...
            "horizons": R11_MULTI_HORIZON_YEARS,
            "r10_required": True,
            "hypothesis": "The current publication blocker is removed only when R18 beats carry-forward and matched R10 with fitted ART process evidence rather than a frozen R10 teacher.",
        },
    ]
