...
def _r13_priority_experiment_specs() -> list[dict[str, Any]]:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R20 service-capacity diagnosis/VL/suppression stress test",
            "family": "r20_service_capacity_process",
            "row_scope": "program",
            "metrics": tuple(dict.fromkeys(back_half_metrics + flow_metric)),
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If R19 localized the remaining failure correctly, a train-origin service-capacity process should improve diagnosis-flow and third-95 trajectory without weakening matched R10-scope gates.",
        },
        {
