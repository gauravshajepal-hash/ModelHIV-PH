...
def _r13_priority_experiment_specs() -> list[dict[str, Any]]:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R16 support-cadence stock program route stress test",
            "family": "r16_support_cadence_stock_process",
            "row_scope": "program",
            "metrics": da_metrics,
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If the remaining R10 gap is long-horizon D/A overshoot under mixed HARP support cadence, a train-origin diagnosed-stock cap and flow cadence selector should improve 3y/5y program trajectory without breaking the stock cone.",
        },
        {
        ...
        },
        {
            ...
            "horizons": R11_MULTI_HORIZON_YEARS,
            "r10_required": True,
            "hypothesis": "The current publication blocker is removed only when the R16 support-cadence stock cascade beats carry-forward and matched R10 without weakening stock or rate gates.",
        },
    ]
