...
def _r13_priority_experiment_specs() -> list[dict[str, Any]]:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R19 lineage-aware VL/suppression state-space stress test",
            "family": "r19_lineage_state_space_back_half_process",
            "row_scope": "program",
            "metrics": tuple(dict.fromkeys(back_half_metrics + flow_metric)),
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If R19 localized the remaining failure correctly, a train-origin lineage-aware third-95 rate state should improve VL/suppression trajectory without weakening matched R10-scope gates.",
        },
        {
