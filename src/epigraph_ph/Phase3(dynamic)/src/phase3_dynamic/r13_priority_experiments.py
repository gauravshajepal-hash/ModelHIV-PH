...
def _r13_priority_experiment_specs() -> list[dict[str, Any]]:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "title": "Latent monthly program nowcast on DOH program evidence",
            "family": "r12_program_nowcast_mixed_quarterly_process",
            "row_scope": "program",
            "metrics": r10_metrics,
            "horizons": (1, 2),
            "r10_required": True,
            "hypothesis": "If the latent reporting-intensity state is useful, it should improve 1y/2y diagnosis, ART, and diagnosis-flow nowcasts on DOH program rows.",
        },
        {
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "Program route trajectory stress test",
            "family": "r12_program_nowcast_mixed_quarterly_process",
            "row_scope": "program",
            "metrics": da_metrics,
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If the remaining R10 gap is a transition problem, it will remain visible on 3y/5y program D/A stock horizons.",
        },
        {
        ...
        },
        {
            ...
            "priority": 26,
            "layer": "program_route",
            "title": "Program D/A nowcast with latent monthly state",
            "family": "r12_program_nowcast_mixed_quarterly_process",
            "row_scope": "program",
            "metrics": da_metrics,
            "horizons": (1, 2),
        ...
        },
        {
            ...
            "priority": 30,
            "layer": "shock_period",
            "title": "Post-2021 program nowcast stress test",
            "family": "r12_program_nowcast_mixed_quarterly_process",
        ...
        },
        {
            ...
            "priority": 47,
            "layer": "annual_official_measurement",
            "title": "Conserved annual gate on R12 program branch",
            "family": "official_annual_challenge_gate",
        ...
        },
        {
            ...
            "horizons": R11_MULTI_HORIZON_YEARS,
            "r10_required": True,
            "hypothesis": "The current publication blocker is removed only when the full cascade beats carry-forward and matched R10 without weakening stock or rate gates.",
        },
    ]
