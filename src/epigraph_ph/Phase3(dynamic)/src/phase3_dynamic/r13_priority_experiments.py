...
def _r13_priority_experiment_specs() -> list[dict[str, Any]]:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R19 joint ART/VL/suppression service process stress test",
            "family": "r19_joint_service_cascade_process",
            "row_scope": "program",
            "metrics": tuple(dict.fromkeys(back_half_metrics + flow_metric)),
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If R18 localized the remaining failure correctly, a train-origin joint service process should improve ART-mediated VL/suppression and diagnosis-flow trajectory without weakening matched R10-scope gates.",
        },
        {
