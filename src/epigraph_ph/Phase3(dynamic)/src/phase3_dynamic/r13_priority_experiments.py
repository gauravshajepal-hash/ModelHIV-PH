    ...
    specs: list[dict[str, Any]] = [
        {
            ...
            "title": "Conserved annual incidence/death/PLHIV gate on R19",
            "family": "official_annual_challenge_gate",
            "candidate_family": "r19_joint_service_cascade_process",
            "row_scope": "official_annual_q4",
            "metrics": tuple(OFFICIAL_ANNUAL_CHALLENGE_METRICS),
            "horizons": (1,),
            "r10_required": False,
            "hypothesis": "The R19 branch is publishable only if annual incidence, deaths, PLHIV, and annual cascade anchors score as a conserved mass-balance triplet without training on validation-only annual targets.",
        },
        {
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R19 joint service cascade program route",
            "family": "r19_joint_service_cascade_process",
            "row_scope": "program",
            "metrics": tuple(dict.fromkeys(back_half_metrics + flow_metric)),
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "R19 remains the active program-route reference unless a later diagnosis-flow or back-half process beats it under carry-forward and matched R10 gates.",
        },
        {
        ...
        },
        {
            ...
            "priority": 41,
            "layer": "program_route",
            "title": "R22 R19/R16 program metric coupling diagnostic",
            "family": "r22_program_metric_coupled_process",
            "row_scope": "program",
            "metrics": tuple(dict.fromkeys(back_half_metrics + flow_metric)),
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If R19 overrode useful R16 program-state dynamics, a predeclared R19/R16 process coupling should improve program service trajectory without using R10 targets or fitted blend weights.",
        },
        {
            "experiment_id": "R13-042",
            "priority": 42,
            "layer": "program_route",
            "title": "R20 service-capacity diagnostic",
            "family": "r20_service_capacity_process",
            "row_scope": "program",
            "metrics": tuple(dict.fromkeys(back_half_metrics + flow_metric)),
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "The R20 service-capacity branch remains diagnostic unless it improves program diagnosis-flow and third-95 trajectory beyond the active R19 reference.",
        },
        {
            "experiment_id": "R13-043",
            "priority": 43,
            "layer": "diagnosis_flow",
            "title": "R21 guarded diagnosis-flow-only diagnostic",
            "family": "r21_diagnosis_flow_guarded_process",
            "row_scope": "program",
            "metrics": flow_metric,
            "horizons": (1, 2),
            "r10_required": True,
            "hypothesis": "The guarded R21 selector is diagnostic only unless it improves diagnosis-flow shape without mutating D/A, ART, VL, or suppression stocks.",
        },
        {
        ...
        },
        {
            ...
            "horizons": R11_MULTI_HORIZON_YEARS,
            "r10_required": True,
            "hypothesis": "The current publication blocker is removed only when R19 beats carry-forward and matched R10 with fitted ART/VL/suppression/diagnosis-flow process evidence rather than a frozen R10 teacher.",
        },
    ]
