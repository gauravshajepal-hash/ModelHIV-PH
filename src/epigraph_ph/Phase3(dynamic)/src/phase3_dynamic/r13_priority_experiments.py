...
def _r13_priority_experiment_specs() -> list[dict[str, Any]]:
    ...
    specs: list[dict[str, Any]] = [
        ...
        },
        {
            ...
            "priority": 6,
            "layer": "program_route",
            "title": "R14B calibrated program route trajectory stress test",
            "family": "r14_program_long_horizon_calibrated_process",
            "row_scope": "program",
            "metrics": da_metrics,
            "horizons": (3, 5),
            "r10_required": True,
            "hypothesis": "If the remaining R10 gap is long-horizon D/A drift, a train-origin calibrated R14B correction should improve 3y/5y program trajectory without breaking the stock cone.",
        },
        {
        ...
        },
        {
            ...
            "horizons": R11_MULTI_HORIZON_YEARS,
            "r10_required": True,
            "hypothesis": "The current publication blocker is removed only when the calibrated R14B cascade beats carry-forward and matched R10 without weakening stock or rate gates.",
        },
    ]
