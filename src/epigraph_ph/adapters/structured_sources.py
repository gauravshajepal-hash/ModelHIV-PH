...
def _hiv_structured_source_adapters() -> list[StructuredSourceAdapterSpec]:
    return [
        ...
        StructuredSourceAdapterSpec(
            adapter_id="harp_monthly_registry",
            source_name="HIV/AIDS & ART Registry of the Philippines (Monthly HARP)",
            organization="Department of Health Epidemiology Bureau / Philippine National AIDS Council",
            source_tier="tier1_official_program_registry",
            access_mode="public_monthly_pdf_bulletin",
            spatial_resolution="national_with_regional_breakouts",
            temporal_resolution="monthly",
            landing_url="https://pnac.doh.gov.ph/",
            determinant_silos=["testing_uptake", "linkage_to_care", "retention_adherence", "suppression_outcomes"],
            promotion_track="main_predictive",
            platform="pnac_harp",
            seed_queries=[
                "site:pnac.doh.gov.ph HARP January 2025 pdf",
                "site:pnac.doh.gov.ph HARP December 2024 pdf",
                "site:pnac.doh.gov.ph HIV/AIDS & ART Registry of the Philippines monthly pdf",
            ],
            preferred_file_patterns=["*HARP*", "*HIV/AIDS*&*ART*Registry*", "*monthly*", "*.pdf"],
            fallback_urls=[
                "https://pnac.doh.gov.ph/",
                "https://www.foi.gov.ph/",
            ],
            historical_records=[
                _historical_record(
                    title="HARP June 2023",
                    url="https://pnac.doh.gov.ph/wp-content/uploads/2023/10/HARP-June-2023.pdf",
                    year=2023,
                    document_type="monthly_registry_pdf",
                    notes=[
                        "Official monthly national HIV registry bulletin.",
                        "Contains newly diagnosed counts, treatment enrollment, deaths, and regional distribution summaries.",
                    ],
                ),
            ],
            notes=[
                "This is the strongest public monthly national HIV signal source currently identifiable online for the Philippines.",
                "Prefer direct ingestion of monthly case, ART, death, and regional-count tables over narrative summaries.",
            ],
        ),
        StructuredSourceAdapterSpec(
            adapter_id="stihiv_denominator_surveillance_monthly",
            source_name="STI/HIV Denominator Surveillance System (Monthly Laboratory and Blood Bank Reporting)",
            organization="Department of Health Epidemiology Bureau",
            source_tier="tier1_official_surveillance",
            access_mode="public_program_brief_and_monthly_reporting_channel",
            spatial_resolution="facility_to_national",
            temporal_resolution="monthly",
            landing_url="https://caro.doh.gov.ph/wp-content/uploads/2021/11/Program-Briefer_2020_UPDATED_FINAL.pdf",
            determinant_silos=["testing_uptake", "prevention_access", "health_system_reach"],
            promotion_track="main_predictive",
            platform="doh_sdss",
            seed_queries=[
                "site:doh.gov.ph STI/HIV Denominator Surveillance System monthly report pdf",
                "site:doh.gov.ph HIV laboratory blood bank surveillance monthly report",
                "site:doh.gov.ph HIV testing laboratory monthly reports Philippines",
            ],
            preferred_file_patterns=["*denominator*surveillance*", "*monthly*", "*laboratory*", "*blood*bank*", "*.pdf"],
            fallback_urls=[
                "https://caro.doh.gov.ph/wp-content/uploads/2021/11/Program-Briefer_2020_UPDATED_FINAL.pdf",
                "https://doh.gov.ph/statistics",
            ],
            historical_records=[
                _historical_record(
                    title="DOH Program Briefer 2020 Updated Final",
                    url="https://caro.doh.gov.ph/wp-content/uploads/2021/11/Program-Briefer_2020_UPDATED_FINAL.pdf",
                    year=2020,
                    document_type="program_brief_pdf",
                    notes=[
                        "Describes the STI/HIV Denominator Surveillance System.",
                        "States that HIV testing laboratories and blood banks submit monthly reports on tests performed and results.",
                    ],
                ),
            ],
            notes=[
                "Use this source family for true monthly testing denominators and positivity-related signal, not just annual HIV care cascade stocks.",
                "This is especially relevant because the present Philippine bottleneck is testing and diagnosis.",
            ],
        ),
        StructuredSourceAdapterSpec(
            adapter_id="regional_hiv_surveillance_monthly",
            source_name="Regional STI/HIV-AIDS Surveillance Monthly Reports",
            organization="DOH Regional Epidemiology and Surveillance Units",
            source_tier="tier1_regional_surveillance",
            access_mode="public_monthly_regional_report_hub",
            spatial_resolution="regional",
            temporal_resolution="monthly",
            landing_url="https://www.resu.online/reports",
            determinant_silos=["testing_uptake", "linkage_to_care", "health_system_reach", "transport_friction"],
            promotion_track="main_predictive",
            platform="regional_resu_hiv",
            seed_queries=[
                "site:resu.online STI/HIV-AIDS surveillance monthly report",
                "site:resu.online HIV/AIDS monthly report DOH regional",
                "site:resu.online monthly HIV surveillance Philippines region",
            ],
            preferred_file_patterns=["*HIV/AIDS*", "*STI/HIV-AIDS*Surveillance*", "*Monthly*Report*"],
            fallback_urls=[
                "https://www.resu.online/reports",
            ],
            historical_records=[
                _historical_record(
                    title="CRE@TE onLINE STI/HIV-AIDS Surveillance Monthly Report Hub",
                    url="https://www.resu.online/reports",
                    year=2026,
                    document_type="monthly_report_hub",
                    notes=[
                        "Regional surveillance portal exposing monthly STI/HIV-AIDS reports.",
                        "Useful for obtaining region-level monthly signal where national monthly anchors are too sparse.",
                    ],
                ),
            ],
            notes=[
                "Use as a regional monthly signal layer to reduce the current annual-anchor dominance of Phase 3.",
                "Treat as surveillance monitoring data and cross-check against national HARP when building anchors.",
            ],
        ),
        StructuredSourceAdapterSpec(
            adapter_id="ndhs",
